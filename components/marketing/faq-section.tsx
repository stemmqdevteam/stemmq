...
const faqs = [
  ...
  { title: "How do AI agents work in StemmQ?", content: "AI agents analyze data, propose decisions, challenge assumptions, and run simulations. Every agent action goes through human-in-the-loop approval gates. All proposals are auditable and can be approved, modified, or rejected by authorized team members." },
