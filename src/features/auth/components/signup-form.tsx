...
import { Mail, User, Building2, ArrowRight, CheckCircle2, Loader2, ChevronLeft } from 'lucide-react'
...
/* Step indicator dots */
function StepDots({ current }: { current: 'account' | 'workspace' }) {
...
export function SignupForm() {
    ...
    return (
      ...
      >
        ...
        <p className="text-xs text-muted-foreground mb-8 leading-relaxed">
          Click the link to verify your email and set up your workspace.
  ...
  return (
    ...
    >
      {/* Step dots */}
      {<StepDots current={step as 'account' | 'workspace'} />}
